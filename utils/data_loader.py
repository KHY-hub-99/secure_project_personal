...
def save_defense_pattern(category:str, sub_category:str, attack_prompt:str, defense_output:str, judgment:str, reason:str, out_path:str):
...
def save_generated_attack(category:str, sub_category:str, attack_prompt:str, blue_response:str, round_num:int, judgment:str, reason:str, out_path:str):
    """
